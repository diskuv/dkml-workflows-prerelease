...
.PARAMETER PIN_IOSTREAM_CAMLZIP
Environment variable.
...
.PARAMETER PIN_TINY_HTTPD_CAMLZIP
Environment variable.
...
param (
  ...
  ,[Parameter()] [string] $PIN_CAMLZIP = "1.11"
  ...
  ,[Parameter()] [string] $PIN_CONF_ZLIB = "1"
  ...
  ,[Parameter()] [string] $PIN_IOSTREAM_CAMLZIP = "0.2.2"
  ...
  ,[Parameter()] [string] $PIN_TINY_HTTPD_CAMLZIP = "0.16"
...
$env:PIN_CONF_ZLIB = $PIN_CONF_ZLIB
...
$env:PIN_IOSTREAM_CAMLZIP = $PIN_IOSTREAM_CAMLZIP
...
$env:PIN_TINY_HTTPD_CAMLZIP = $PIN_TINY_HTTPD_CAMLZIP
