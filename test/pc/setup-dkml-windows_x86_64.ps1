...
$env:PC_PROJECT_DIR = $PROJECT_DIR
...
$env:opam_root = "${env:PC_PROJECT_DIR}/.opam"
...
msys64\usr\bin\bash -lc "sh run-checkout-code.sh PWD '${PWD}'"
...
msys64\usr\bin\bash -lc "sh run-setup-dkml.sh PWD '${PWD}'"
