...
param (
  ...
  ,[Parameter()] [string] $PIN_DUNE_ACTION_PLUGIN = "3.9.1"
  ,[Parameter()] [string] $PIN_DUNE_BUILD_INFO = "3.8.3"
  ,[Parameter()] [string] $PIN_DUNE_CONFIGURATOR = "3.8.3"
  ,[Parameter()] [string] $PIN_DUNE_GLOB = "3.9.1"
  ,[Parameter()] [string] $PIN_DUNE_PRIVATE_LIBS = "3.9.1"
  ,[Parameter()] [string] $PIN_DUNE_RPC_LWT = "3.9.1"
  ,[Parameter()] [string] $PIN_DUNE_RPC = "3.9.1"
  ,[Parameter()] [string] $PIN_DUNE_SITE = "3.9.1"
  ,[Parameter()] [string] $PIN_DUNE = "3.8.3"
  ,[Parameter()] [string] $PIN_DYN = "3.9.1"
  ...
  ,[Parameter()] [string] $PIN_OCAMLC_LOC = "3.9.1"
  ...
  ,[Parameter()] [string] $PIN_ORDERING = "3.9.1"
  ...
  ,[Parameter()] [string] $PIN_STDUNE = "3.9.1"
