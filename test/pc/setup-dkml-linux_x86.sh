...
export PIN_DKML_COMPONENT_COMMON_DESKTOP='2.1.4'
export PIN_DKML_COMPONENT_COMMON_OPAM='2.2.1'
export PIN_DKML_COMPONENT_COMMON_UNIXUTILS='0.2.0'
export PIN_DKML_COMPONENT_OCAMLCOMPILER_COMMON='4.14.2~v2.1.4'
export PIN_DKML_COMPONENT_OCAMLCOMPILER_NETWORK='4.14.2~v2.1.4'
export PIN_DKML_COMPONENT_OCAMLCOMPILER_OFFLINE='4.14.2~v2.1.4'
export PIN_DKML_COMPONENT_OFFLINE_DESKTOP_FULL='2.1.4'
export PIN_DKML_COMPONENT_OFFLINE_OPAMSHIM='2.2.1'
export PIN_DKML_COMPONENT_OFFLINE_UNIXUTILS='0.2.0'
export PIN_DKML_COMPONENT_STAGING_DESKTOP_FULL='2.1.4'
export PIN_DKML_COMPONENT_STAGING_DKMLCONFDIR='2.1.4'
export PIN_DKML_COMPONENT_STAGING_OCAMLRUN='4.14.2~v2.1.4'
...
export PIN_DKML_COMPONENT_STAGING_WITHDKML='2.1.4'
