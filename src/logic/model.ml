...
let global_env_vars =
  [
    ("DEFAULT_DKML_COMPILER", "4.14.0-v1.2.1-10");
    ...
    ("PIN_BASE_QUICKCHECK", "v0.15.0");
    ("PIN_BIGARRAY_COMPAT", "1.1.0");
    ("PIN_BIGSTRINGAF", "0.9.0+msvc");
    ("PIN_BIN_PROT", "v0.15.0");
    ("PIN_BOS", "0.2.1");
    ("PIN_CAMLP_STREAMS", "5.0.1");
    ("PIN_CHECKSEUM", "0.3.4+android");
    ("PIN_CMDLINER", "1.1.1");
    ...
    ("PIN_FEATHER", "0.3.0");
    ("PIN_FIBER", "3.6.2");
    ("PIN_FIELDSLIB", "v0.15.0");
    ("PIN_FIX", "20230505");
    ("PIN_FMT", "0.9.0");
    ("PIN_FPATH", "0.7.3");
    ("PIN_INT_REPR", "v0.15.0");
    ("PIN_INTEGERS", "0.7.0");
    ("PIN_JANE_STREET_HEADERS", "v0.15.0");
    ("PIN_JSONRPC", "1.12.2");
    ("PIN_JST_CONFIG", "v0.15.1");
    ...
    ("PIN_OCAMLFIND", "1.9.1");
    ("PIN_OCAMLFORMAT_RPC_LIB", "0.24.1");
    ("PIN_OCAMLFORMAT", "0.24.1");
    ...
    ("PIN_PARSEXP", "v0.15.0");
    ("PIN_PP", "1.1.2");
    ("PIN_PPX_ASSERT", "v0.15.0");
    ("PIN_PPX_BASE", "v0.15.0");
    ("PIN_PPX_BENCH", "v0.15.1");
    ("PIN_PPX_BIN_PROT", "v0.15.0");
    ("PIN_PPX_COLD", "v0.15.0");
    ("PIN_PPX_COMPARE", "v0.15.0");
    ("PIN_PPX_CUSTOM_PRINTF", "v0.15.0");
    ("PIN_PPX_DERIVERS", "1.2.1");
    ("PIN_PPX_DERIVING", "5.2.1");
    ("PIN_PPX_DISABLE_UNUSED_WARNINGS", "v0.15.0");
    ("PIN_PPX_ENUMERATE", "v0.15.0");
    ("PIN_PPX_EXPECT", "v0.15.1");
    ("PIN_PPX_FIELDS_CONV", "v0.15.0");
    ("PIN_PPX_FIXED_LITERAL", "v0.15.0");
    ("PIN_PPX_HASH", "v0.15.0");
    ("PIN_PPX_HERE", "v0.15.0");
    ("PIN_PPX_IGNORE_INSTRUMENTATION", "v0.15.0");
    ("PIN_PPX_INLINE_TEST", "v0.15.1");
    ("PIN_PPX_JANE", "v0.15.0");
    ("PIN_PPX_LET", "v0.15.0");
    ("PIN_PPX_LOG", "v0.15.0");
    ("PIN_PPX_MODULE_TIMER", "v0.15.0");
    ("PIN_PPX_OPTCOMP", "v0.15.0");
    ("PIN_PPX_OPTIONAL", "v0.15.0");
    ("PIN_PPX_PIPEBANG", "v0.15.0");
    ("PIN_PPX_SEXP_CONV", "v0.15.1");
    ("PIN_PPX_SEXP_MESSAGE", "v0.15.0");
    ("PIN_PPX_SEXP_VALUE", "v0.15.0");
    ("PIN_PPX_STABLE", "v0.15.0");
    ("PIN_PPX_STRING", "v0.15.0");
    ("PIN_PPX_TYPEREP_CONV", "v0.15.0");
    ("PIN_PPX_VARIANTS_CONV", "v0.15.0");
    ...
    ("PIN_SEQ", "base");
    ("PIN_SEXPLIB", "v0.15.1");
    ("PIN_SEXPLIB0", "v0.15.1");
    ("PIN_SHA", "1.15.2");
    ("PIN_SPAWN", "0.15.1+android");
    ("PIN_SPLITTABLE_RANDOM", "v0.15.0");
    ("PIN_STDIO", "v0.15.0");
    ("PIN_STDLIB_SHIMS", "0.3.0");
    ("PIN_STDUNE", "3.6.2");
    ("PIN_TIME_NOW", "v0.15.0");
    ("PIN_TOPKG", "1.0.7");
    ("PIN_TRIE", "1.0.0");
    ("PIN_TYPEREP", "v0.15.0");
    ("PIN_TYXML", "4.5.0");
