...
let global_env_vars =
  [
    ...
    ("PIN_CSEXP", "1.5.2");
    ("PIN_CSTRUCT", "6.2.0");
    ("PIN_CTYPES_FOREIGN", "0.19.2-windowssupport-r6");
    ("PIN_CTYPES", "0.19.2-windowssupport-r6");
    ("PIN_CUDF", "0.10");
    ("PIN_DIGESTIF", "1.1.4");
    ("PIN_DISKUVBOX", "0.2.0");
    ("PIN_DKML_APPS", "1.2.1~prerel12");
    ("PIN_DKML_BASE_COMPILER", "4.14.0~v1.2.1~prerel12");
    ("PIN_DKML_BUILD_DESKTOP", "1.2.1~prerel12");
    ("PIN_DKML_C_PROBE", "3.0.0");
    ("PIN_DKML_COMPILER_ENV", "1.2.1~prerel12");
    ("PIN_DKML_COMPILER_SRC", "1.2.1~prerel12");
    ("PIN_DKML_COMPONENT_COMMON_DESKTOP", "1.2.1~prerel12");
    ("PIN_DKML_COMPONENT_COMMON_OPAM", "2.2.0~alpha0~20221228");
    ("PIN_DKML_COMPONENT_COMMON_UNIXUTILS", "0.2.0");
    ("PIN_DKML_COMPONENT_NETWORK_OCAMLCOMPILER", "4.14.0~v1.2.1~prerel12");
    ("PIN_DKML_COMPONENT_OCAMLCOMPILER_COMMON", "4.14.0~v1.2.1~prerel12");
    ("PIN_DKML_COMPONENT_OCAMLCOMPILER_NETWORK", "4.14.0~v1.2.1~prerel12");
    ("PIN_DKML_COMPONENT_OFFLINE_DESKTOP_FULL", "1.2.1~prerel12");
    ("PIN_DKML_COMPONENT_OFFLINE_OPAMSHIM", "2.2.0~alpha0~20221228");
    ("PIN_DKML_COMPONENT_OFFLINE_UNIXUTILS", "0.2.0");
    ("PIN_DKML_COMPONENT_STAGING_DESKTOP_FULL", "1.2.1~prerel12");
    ("PIN_DKML_COMPONENT_STAGING_DKMLCONFDIR", "1.2.1~prerel12");
    ("PIN_DKML_COMPONENT_STAGING_OCAMLRUN", "4.14.0~v1.2.1~prerel12");
    ...
    ("PIN_DKML_COMPONENT_STAGING_WITHDKML", "1.2.1~prerel12");
    ("PIN_DKML_COMPONENT_XX_CONSOLE", "0.1.1");
    ("PIN_DKML_EXE_LIB", "1.2.1~prerel12");
    ("PIN_DKML_EXE", "1.2.1~prerel12");
    ("PIN_DKML_INSTALL_INSTALLER", "0.4.0");
    ("PIN_DKML_INSTALL_RUNNER", "0.4.0");
    ("PIN_DKML_INSTALL", "0.4.0");
    ("PIN_DKML_PACKAGE_CONSOLE", "0.4.0");
    ("PIN_DKML_RUNTIME_COMMON_NATIVE", "1.2.1~prerel12");
    ("PIN_DKML_RUNTIME_COMMON", "1.2.1~prerel12");
    ("PIN_DKML_RUNTIME_DISTRIBUTION", "1.2.1~prerel12");
    ("PIN_DKML_RUNTIMELIB", "1.2.1~prerel12");
    ("PIN_DKML_RUNTIMESCRIPTS", "1.2.1~prerel12");
    ("PIN_DKML_WORKFLOWS", "1.2.1~prerel12");
    ...
    ("PIN_OCAML_VERSION", "3.6.1");
    ("PIN_OCAML", "4.14.0");
    ("PIN_OCAMLBUILD", "0.14.2+win");
