...
let global_env_vars =
  [
    ...
    ("PIN_DKML_COMPONENT_NETWORK_OCAMLCOMPILER", "4.14.0~v1.2.1~prerel10");
    ...
    ("PIN_DKML_COMPONENT_STAGING_OCAMLRUN", "4.14.0~v1.2.1~prerel10");
    ...
    ("PIN_DKML_INSTALLER_NETWORK_OCAML", "1.2.1~prerel10");
    ...
    ("PIN_PPX_DISABLE_UNUSED_WARNINGS", "v0.16.0");
    ("PIN_PPX_ENUMERATE", "v0.16.0");
    ("PIN_PPX_EXPECT", "v0.16.0");
    ("PIN_PPX_FIELDS_CONV", "v0.16.0");
    ("PIN_PPX_FIXED_LITERAL", "v0.16.0");
    ...
    ("PIN_PPX_OPTIONAL", "v0.16.0");
    ("PIN_PPX_PIPEBANG", "v0.15.0");
    ("PIN_PPX_SEXP_CONV", "v0.16.0");
    ("PIN_PPX_STABLE", "v0.16.0");
    ("PIN_PPX_TYPEREP_CONV", "v0.16.0");
