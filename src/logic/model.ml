...
let global_env_vars =
  [
    ...
    ("PIN_DISKUVBOX", "0.2.0");
    ("PIN_DKML_APPS", "2.0.3");
    ("PIN_DKML_BASE_COMPILER", "4.14.0~v2.0.3");
    ("PIN_DKML_BUILD_DESKTOP", "2.0.3");
    ("PIN_DKML_C_PROBE", "3.0.0");
    ("PIN_DKML_COMPILER_ENV", "2.0.3");
    ("PIN_DKML_COMPILER_SRC", "2.0.3");
    ...
    ("PIN_DKML_RUNTIME_DISTRIBUTION", "2.0.3");
    ("PIN_DKML_RUNTIMELIB", "2.0.3");
    ("PIN_DKML_RUNTIMESCRIPTS", "2.0.3");
    ("PIN_DKML_WORKFLOWS", "2.0.3");
